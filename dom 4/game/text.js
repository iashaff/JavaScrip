var works = {
    ...
    d00: 'Вы решили прилеч на траву и посомтреть на красивое голубое небо.\n' +
    'Появляются облака различной формы, и Ваша фантазия начинает играть. \n' +
    'Вот проплывает крокодил, а вот и парусник устремился вдаль по волнам. \n' +
    'Вы чувствуете манящий запах обеда и решаете...\n',
    d0: 2, // кол-во ответов
    d1: '1 - Посмотреть еще на облака\n',
    d2: '2 - Пойти пообедать\n',
};
